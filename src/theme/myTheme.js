const myTheme = {
    ...
    alert: {
      ...
      withClose: "pr-12",
      success:
        "bg-emerald-50 text-orange dark:bg-emerald-600 dark:text-white",
      ...
      icon: {
        base: "h-5 w-5",
        success: "text-orange dark:text-orange",
    ...
    // Modal
    modal: {
      base: "w-full px-6 py-4 overflow-auto bg-white rounded-t-lg dark:bg-gray-800 sm:rounded-lg sm:m-4 sm:max-w-xl custom-modal max-h-[100vh]",
    },
    // ModalBody
    modalBody: {
    ...
    // Badge
    badge: {
      base: "text-white inline-flex px-2 text-xs font-medium leading-5 rounded-full",
      success:
        "text-white bg-emerald-600",
      danger: "text-white bg-red-100 dark:bg-red-800",
      warning: "text-white bg-yellow-100 dark:bg-yellow-600",
      neutral: "text-white bg-gray-100 dark:bg-gray-800",
      primary: "text-white bg-blue-100 dark:bg-blue-800",
    },
    // Backdrop
    backdrop: {
    ...
    textarea: {
      ...
      valid:
        "border-emerald-600 dark:bg-gray-700 focus:border-orange dark:focus:border-orange",
      invalid:
        "border-red-600 dark:bg-gray-700 focus:border-red-400 dark:focus:border-red-400",
    },
    // Select
    select: {
      base: "block w-fit h-12 border bg-gray-100 px-2 py-1 text-sm dark:text-gray-300 focus:outline-none rounded-md form-select focus:bg-white dark:focus:bg-gray-700",
      active:
    ...
    input: {
      ...
      invalid:
        "border-red-600 dark:bg-gray-700 focus:border-red-400 dark:focus:border-red-400",
      radio:
        "text-orange form-radio focus:border-orange focus:outline-none",
      checkbox:
        "text-orange form-checkbox focus:border-orange focus:outline-none rounded",
    },
    // HelperText
    helperText: {
      base: "text-xs",
      valid: "text-orange dark:text-orange",
    ...
    button: {
      ...
      primary: {
        base: "text-white bg-orange border border-transparent",
      ...
      outline: {
        base: "text-black border-gray-200 border dark:text-black focus:outline-none",
        active:
